  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-900 p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle className="text-xl">Deploy your React Project</CardTitle>
          <CardDescription>
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <Input
                ...
                readOnly
                type="url"
                value={`http://${uploadId}.dev.vercel-deploymate.com:3001/index.html`}
              />
            </div>
            <br />
            <Button className="w-full" variant="outline">
              <a
                href={`http://${uploadId}.vercel-deploymante.com/index.html`}
                target="_blank"
              >
                Visit Website
              </a>
